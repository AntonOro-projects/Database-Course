...
SET autocommit = 0;
LOCK TABLES BOOKING WRITE, CONTACT WRITE, RESERVATION WRITE, PASSENGER WRITE, ROUTE READ, YEAR READ, WEEKDAY READ, WEEKLYSCHEDULE READ, FLIGHT READ, CREDITCARD WRITE, TICKET WRITE; 
